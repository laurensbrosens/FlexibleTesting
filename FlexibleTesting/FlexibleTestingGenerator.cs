...
""";
    ...
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        ...
        IncrementalValuesProvider<TargetClassData> targetClasses = context.SyntaxProvider.ForAttributeWithMetadataName(
                ...
                if (memberAccess.Expression.ToString() == "Overwrites" && memberAccess.Name is GenericNameSyntax genericName && genericName.Identifier.Text == "ForClass")
                {
                    ...
                    if (typeArgument != null)
                    {
                        ...
                        if (typeInfo.Type != null && typeInfo.Type.TypeKind != TypeKind.Error)
                        {
                            ...
                            return new TargetClassData(namespaceName, className);
                        }
                    }
                }
            }
